...
import datetime
archive_rows_html = ""
for res in reversed(results): # 09, 08
    day = res['day']
...
# Since 10 and 11 are ALREADY inserted ABOVE 7 Sep, the target is now the 10 Sep row! Wait no, 11 Sep is at the top, then 10 Sep, then 7 Sep.
# We want to insert 09 and 08 ABOVE 7 Sep, meaning BETWEEN 10 Sep and 7 Sep.
# So the target to insert before is 7 Sep!
...
if target in arch:
    ...
    with open('market-intelligence-archive.html', 'w', encoding='utf-8') as f:
        f.write(arch)
    print("market-intelligence-archive.html successfully updated with 08 and 09.")
else:
