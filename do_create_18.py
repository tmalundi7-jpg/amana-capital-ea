...
# Define the new article body
new_article_body = '''
<div style="font-size: 1.05rem; line-height: 1.8; color: var(--navy);">
...
# Use regex to replace the content between </h1> and <div class="article-disclaimer"
pattern = re.compile(r'(</h1>)(.*?)(<div class="article-disclaimer")', re.DOTALL)
new_content = pattern.sub(r'\1' + '\n' + new_article_body + '\n' + r'\3', content)

with open(r'C:\Users\tmalu\.gemini\antigravity\scratch\Amana-capital-ea\dse-wrap-2026-09-18.html', 'w', encoding='utf-8') as f:
    f.write(new_content)
print("Created dse-wrap-2026-09-18.html successfully!")
