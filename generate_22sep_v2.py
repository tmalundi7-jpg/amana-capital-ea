...
txt(page, MARGIN, 860, "Follow Theo Christian for unfiltered market psychology.", size=20, color=GOLD, bold=True)

# Save
out_path = r'C:\Users\tmalu\Desktop\Amana_DSE_Daily_Wrap_22Sep_COMPANY_v2.pdf'
