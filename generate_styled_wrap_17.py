...
if start_marker not in template:
    start_marker = '<p style="font-size: 1.1rem; color: var(--mist); margin-bottom: 2rem; font-weight: 600;">Third CRDB Block Seals the Handover as Foreign Buyers Begin to Return</p>'
end_marker = '</div>\n        </div>\n    </main>'
...
print("Generated absolutely clean dse-wrap-2026-07-17.html successfully.")
