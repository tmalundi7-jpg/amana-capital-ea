...
wow_factor_css = """
        ...
        .apply-it { background-color: var(--stone); border: 1px solid var(--gold); padding: 2rem; margin: 3rem 0; border-radius: 8px; position: relative; }
        .apply-it p { margin-bottom: 0; color: var(--navy); }
        .apply-it p:first-child strong { color: var(--gold); text-transform: uppercase; letter-spacing: 1px; font-size: 0.9rem; display: block; margin-bottom: 0.5rem; }
        ...
        .article-disclaimer { border: 1px solid var(--gold); background-color: var(--stone); padding: 2rem; margin-top: 4rem; color: var(--navy); font-size: 0.9rem; line-height: 1.6; text-align: justify; border-radius: 8px; }
"""
