...
window.initDSEHeatmap = function() {
    ...
    if (!container) return;
        ...
        { symbol: 'CRDB', marketCap: 1515, change: -2.7 },
        { symbol: 'VODA', marketCap: 1200, change: 0.8 },
        { symbol: 'TPCC', marketCap: 900, change: 0.0 },
        { symbol: 'NICO', marketCap: 700, change: -1.9 },
        { symbol: 'TCC', marketCap: 1500, change: -0.4 },
        { symbol: 'TCCL', marketCap: 120, change: 5.4 },
        { symbol: 'TOL', marketCap: 85, change: -0.5 },
        { symbol: 'SWIS', marketCap: 100, change: 2.7 },
        { symbol: 'DCB', marketCap: 80, change: 1.1 },
        { symbol: 'AFRIPRISE', marketCap: 200, change: 13.3 },
        { symbol: 'MCB', marketCap: 62, change: -1.3 },
        { symbol: 'PAL', marketCap: 50, change: 3.2 }
      ];
