...
window.initDSEHeatmap = function() {
    ...
    const data = [
        ...
        { symbol: 'CRDB',      marketCap: 1519, change:  0.4 },
        { symbol: 'VODA',      marketCap: 1200, change:  0.0 },
        { symbol: 'KCB',       marketCap: 950,  change:  0.0 },
        { symbol: 'TPCC',      marketCap: 895,  change: -0.5 },
        { symbol: 'NICO',      marketCap: 600,  change: -0.5 },
        { symbol: 'DSE',       marketCap: 154,  change:  1.6 },
        { symbol: 'TCCL',      marketCap: 119,  change: -3.9 },
        { symbol: 'SWIS',      marketCap: 100,  change:  0.0 },
        { symbol: 'MBP',       marketCap: 90,   change:  9.9 },
        { symbol: 'MCB',       marketCap: 85,   change:  7.1 },
        { symbol: 'TOL',       marketCap: 82,   change:  6.9 },
        { symbol: 'DCB',       marketCap: 80,   change:  4.2 },
        { symbol: 'MKCB',      marketCap: 72,   change:  1.3 },
        { symbol: 'PAL',       marketCap: 60,   change: -4.7 },
        { symbol: 'AFRIPRISE', marketCap: 58,   change: -1.6 },
        { symbol: 'TCC',       marketCap: 55,   change:  0.0 },
        { symbol: 'MUCOBA',    marketCap: 55,   change:  0.0 },
        { symbol: 'TTP',       marketCap: 50,   change:  0.0 }
    ];
