...
window.initBondCalculator = function() {
    ...
    const outNetYield = document.getElementById('out-net-yield');
    ...
    // Attach listeners
    const inputs = [fvInput, crInput, myInput, ppyInput, mpInput, dslcInput, taxRateInput, cyInput, cpInput, invAmtInput, inflInput];
    ...
    function calculateAnalytics() {
        ...
        const netYield = solveYield(priceValue, matPeriods, matRedemption, fv, cr * (1 - taxRate), ppy, dslc);
        if (outNetYield) outNetYield.textContent = (netYield * 100).toFixed(4) + '%';
...
window.initDSEHeatmap = function() {
    ...
    if (!container) return;
        ...
        { symbol: 'NICO', marketCap: 700, change: -1.5 },
        ...
        { symbol: 'MKCB', marketCap: 55, change: 0.5 }
    ];
...
if (typeof swup !== "undefined") {
  swup.hooks.on("page:view", () => {
    if (typeof window.initDSEHeatmap === "function") window.initDSEHeatmap();
    if (typeof Weglot !== "undefined") Weglot.initialize({ api_key: "wg_22a6f434974df4dee513e25f34fc5e009" });
  });
}
// ============================================
// MOBILE TABLE SCROLL AFFORDANCE (UX)
// ============================================
document.addEventListener("DOMContentLoaded", function() {
  const wrappers = document.querySelectorAll(".table-wrapper");
  
  wrappers.forEach(wrapper => {
    // Check if the table overflows (scrollable)
    ...
    const checkScrollEnd = () => {
      ...
      if (isAtEnd) {
        wrapper.classList.add("is-scrolled-end");
      } else {
        wrapper.classList.remove("is-scrolled-end");
      }
    };
    ...
    wrapper.addEventListener("scroll", checkScrollable);
  });
});
...
// ============================================
document.addEventListener("DOMContentLoaded", function() {
  const heroBg = document.querySelector(".enhanced-hero .hero-background");
  if (heroBg) {
    window.addEventListener("scroll", function() {
      ...
      if (hero) {
        ...
        const offset = (scrollY - heroTop) * 0.4;
        heroBg.style.transform = 	ranslateY(%);
      }
    }, { passive: true });
  }
});
...
// ============================================
// ANIMATED DATA VISUALISATIONS (Chart.js)
// ============================================
const chartAnimationConfig = {
  ...
  transitions: {
    show: {
      animations: {
        scale: { from: 0.8, to: 1, duration: 800, easing: "easeOutCubic" },
        opacity: { from: 0, to: 1, duration: 600, easing: "easeOutCubic" }
      }
    }
  }
};
window.chartAnimationConfig = chartAnimationConfig;



// ============================================
// PHASE 3: SKELETON LOADING & THEME TOGGLE
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const sections = ['market-snapshot', 'daily-wraps', 'top-gainers'];
  sections.forEach(section => { skeleton.show(section); });
  setTimeout(() => {
    sections.forEach(section => { skeleton.hide(section); });
  }, 800);
