$dir = "C:\Users\tmalu\GitHub\amana-capital-ea"
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-links">
                ...
                <div style="display:flex; gap:1.5rem;"><a href="/privacy">Privacy Policy</a> <a href="/terms">Terms of Use</a> <a href="/cookies">Cookie Policy</a></div>
...
foreach ($file in $files) {
    ...
    if ($name -eq "about.html") {
        $activeNav = $activeNav -replace '<li><a href="/about">About</a></li>', '<li><a href="/about" class="active">About</a></li>'
    }
    elseif ($name -eq "contact.html") {
        $activeNav = $activeNav -replace '<li><a href="/contact">Contact</a></li>', '<li><a href="/contact" class="active">Contact</a></li>'
    }
    elseif ($name -eq "market-intelligence.html" -or $name -like "dse-wrap-*" -or $name -eq "current-prices.html") {
        $activeNav = $activeNav -replace '<li><a href="/market-intelligence">Market Intelligence</a></li>', '<li><a href="/market-intelligence" class="active">Market Intelligence</a></li>'
    }
    elseif ($name -like "article-*" -or $name -like "investing-101-*") {
        $activeNav = $activeNav -replace '<li><a href="/education">Investor Education</a></li>', '<li><a href="/education" class="active">Investor Education</a></li>'
    }
    elseif ($name -eq "bond-calculator.html") {
        $activeNav = $activeNav -replace '<li><a href="/bond-calculator">Bond Calculator</a></li>', '<li><a href="/bond-calculator" class="active">Bond Calculator</a></li>'
    }
