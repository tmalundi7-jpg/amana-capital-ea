...
gainers = '''<div class="snapshot-mover" id="home-gainers" style="display: flex; flex-direction: column; gap: 0.25rem;">
...
c = re.sub(r'<div class="snapshot-mover" id="home-gainers".*?</div>', gainers, c, flags=re.DOTALL)

# Fix losers keeping the exact native format
losers = '''<div class="snapshot-mover" id="home-losers" style="display: flex; flex-direction: column; gap: 0.25rem;">
...
c = re.sub(r'<div class="snapshot-mover" id="home-losers".*?</div>', losers, c, flags=re.DOTALL)
...
print("index.html updated with EXACT format preservation.")
